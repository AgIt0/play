...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Executes the block once for each element. The argument passed to inject will be yielded as
    # the first argument to the block on the first execution.
  end
  ...
  #   # code to read 'file'
  #
  # There's no need of the explicit close and it ensured that the file
  # descriptor is closed regardless how th elbock is left.
  #
